...
import { ClassType, Book_state_text, Book_state_type, AUDIT, REJECT, APPROVE } from '../../util/type'
...
const filterTableData = computed(() => {
    return tableData.value.filter(item => String(item.book_id).includes(search.value))
})
